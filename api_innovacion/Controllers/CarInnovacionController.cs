...
/// <summary>
/// Capa HTTP de `car_innovacion`. No toca SQL: delega todo en el servicio y se
/// limita a traducir el resultado a codigos HTTP (1_constitution.md, Articulo 3).
///
...
public class CarInnovacionController : ControllerBase
{
    ...
    public async Task<IActionResult> Listar([FromQuery] int limite = 1000)
    {
        ...
        try
        {
            ...
            return Ok(new RespuestaLista<CarInnovacion>
            {
